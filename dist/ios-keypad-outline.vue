...
<script>
  export default {
    name: "ios-keypad-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Keypad Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
