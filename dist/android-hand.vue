...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Hand Icon"
      return {
        iconTitle: iconTitle
      }
    },
