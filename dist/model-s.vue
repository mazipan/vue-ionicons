...
<script>
  export default {
    name: "model-s-icon",
    data () {
      let iconTitle = this.title ? this.title : "Model S Icon"
      return {
        iconTitle: iconTitle
      }
    },
