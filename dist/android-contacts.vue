...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Android Contacts Icon"
      return {
        iconTitle: iconTitle
      }
    },
