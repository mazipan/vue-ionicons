...
<script>
  export default {
    name: "ios-americanfootball-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Americanfootball Icon"
      return {
        iconTitle: iconTitle
      }
    },
