...
<script>
  export default {
    name: "ios-world-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios World Icon"
      return {
        iconTitle: iconTitle
      }
    },
