...
<script>
  export default {
    name: "ionic-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ionic Icon"
      return {
        iconTitle: iconTitle
      }
    },
