...
<script>
  export default {
    name: "social-github-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Github Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
