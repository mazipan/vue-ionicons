...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Flask Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
