...
<script>
  export default {
    name: "social-foursquare-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Foursquare Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
