...
<script>
  export default {
    name: "radio-waves-icon",
    data () {
      let iconTitle = this.title ? this.title : "Radio Waves Icon"
      return {
        iconTitle: iconTitle
      }
    },
