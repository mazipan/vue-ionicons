...
<script>
  export default {
    name: "social-google-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Google Icon"
      return {
        iconTitle: iconTitle
      }
    },
