...
<script>
  export default {
    name: "bowtie-icon",
    data () {
      let iconTitle = this.title ? this.title : "Bowtie Icon"
      return {
        iconTitle: iconTitle
      }
    },
