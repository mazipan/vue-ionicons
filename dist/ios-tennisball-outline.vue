...
<script>
  export default {
    name: "ios-tennisball-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Tennisball Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
