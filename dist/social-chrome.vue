...
<script>
  export default {
    name: "social-chrome-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Chrome Icon"
      return {
        iconTitle: iconTitle
      }
    },
