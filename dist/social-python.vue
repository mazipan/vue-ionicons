...
<script>
  export default {
    name: "social-python-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Python Icon"
      return {
        iconTitle: iconTitle
      }
    },
