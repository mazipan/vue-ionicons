...
<script>
  export default {
    name: "soup-can-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Soup Can Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
