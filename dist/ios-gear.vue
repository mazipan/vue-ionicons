...
<script>
  export default {
    name: "ios-gear-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Gear Icon"
      return {
        iconTitle: iconTitle
      }
    },
