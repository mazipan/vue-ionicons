...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Social Skype Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
