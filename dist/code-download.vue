...
<script>
  export default {
    name: "code-download-icon",
    data () {
      let iconTitle = this.title ? this.title : "Code Download Icon"
      return {
        iconTitle: iconTitle
      }
    },
