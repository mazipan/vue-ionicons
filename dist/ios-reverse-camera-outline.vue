...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Ios Reverse Camera Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
