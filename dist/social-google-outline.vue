...
<script>
  export default {
    name: "social-google-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Google Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
