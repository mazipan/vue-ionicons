...
<script>
  export default {
    name: "mouse-icon",
    data () {
      let iconTitle = this.title ? this.title : "Mouse Icon"
      return {
        iconTitle: iconTitle
      }
    },
