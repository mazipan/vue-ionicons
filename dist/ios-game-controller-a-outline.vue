...
<script>
  export default {
    name: "ios-game-controller-a-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Ios Game Controller A Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
