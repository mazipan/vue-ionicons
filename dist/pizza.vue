...
<script>
  export default {
    name: "pizza-icon",
    data () {
      let iconTitle = this.title ? this.title : "Pizza Icon"
      return {
        iconTitle: iconTitle
      }
    },
