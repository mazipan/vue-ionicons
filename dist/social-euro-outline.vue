...
<script>
  export default {
    name: "social-euro-outline-icon",
    data () {
      let iconTitle = this.title ? this.title : "Social Euro Outline Icon"
      return {
        iconTitle: iconTitle
      }
    },
