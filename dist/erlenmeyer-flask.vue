...
<script>
  export default {
    ...
    data () {
      let iconTitle = this.title ? this.title : "Erlenmeyer Flask Icon"
      return {
        iconTitle: iconTitle
      }
    },
